...
import { getMongoUri } from './mongodb-connection-helper';

const uri = getMongoUri();

// Very conservative options for Vercel serverless environment
const options = {
  // Minimal SSL configuration - let the connection string handle SSL
  // Remove explicit TLS settings to avoid conflicts
  // tls: true,
